...
class desincorporacion{
	...
	var $puestos;
	var $primera_vez;
	var $fecha_desincorporacion;
	var $cod_vehiculo;
	var $cod_desincorporacion;
	...
	function get($conn, $id){
		...
		if(!$r->EOF){
			...
			$this->cod_desincorporacion = $r->fields['desincorporado'];
	...
	function add($conn, $id_contribuyente, $fecha_desincorporacion, $cod_desincorporacion, $cod_vehiculo){
		
		
		$q = "INSERT INTO vehiculo.veh_desincorporado ";
		$q.= "(cod_contribuyente, fecha_desincorporacion, cod_desincorporacion, cod_vehiculo) ";
		$q.= "VALUES ";
		$q.= "('$id_contribuyente', '$fecha_desincorporacion', '$cod_desincorporacion', '$cod_vehiculo') ";
		
		$w = "UPDATE vehiculo.vehiculo SET desincorporado=$cod_desincorporacion ";
