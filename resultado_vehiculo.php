...
<td align="center">
<a href="#" onClick="updater(<?=$r->fields['id_vehiculo']?>); return false;" title="Modificar ó Actualizar Registro" ><img src="images/actualizar.gif" width="16" height="10" border="0"></a></td>
<td align="center">
<?
	$id_vehiculo = $r->fields['id_vehiculo'];

	$q="SELECT num_pago FROM vehiculo.det_pago WHERE nro_declaracion='$id_vehiculo' ORDER BY num_pago DESC Limit 1";

	$w = $conn->Execute($q);

	$nro_recibo = $w->fields['num_pago'];

	if(!empty($nro_recibo)) {
?>
		<a href="recibo.pago.pdf.php?nro_recibo=<?=$nro_recibo?>" title="Reporte Ultimo Pago" ><img src="images/reporte.jpg" width="16" height="10" border="0"></a>
