...
include_once($appRoot .'/lib/PHPExcel/Shared/trend/linearBestFitClass.php');
include_once($appRoot .'/lib/PHPExcel/Shared/trend/logarithmicBestFitClass.php');
include_once($appRoot .'/lib/PHPExcel/Shared/trend/exponentialBestFitClass.php');
include_once($appRoot .'/lib/PHPExcel/Shared/trend/powerBestFitClass.php');
include_once($appRoot .'/lib/PHPExcel/Shared/trend/polynomialBestFitClass.php');
