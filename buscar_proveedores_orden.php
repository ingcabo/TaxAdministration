...
<table>
	<tr class="filas">
		<td>Nombre:&nbsp;&nbsp;</td>
		<td><input type="text" name="search_nombre_prov" id="search_nombre_prov" size="30" onKeyUp="busca_popup_prov()" /></td>
	</tr>
	<tr class="filas">
		<td>
		<?
		...
		<td><input type="text" name="search_rif_prov" id="search_rif_prov" size="30" maxlength="12" onKeyUp="busca_popup_prov()" /></td>
	</tr>
	<tr class="filas">
		<td>
		Tipo:
		</td>
		<td><select name="tipo_prov" id="tipo_prov" onchange="busca_popup_prov()" style="width:180px" >
...
?> 
			<tr class="filas">
				<td>
					<span onClick="selDocumento_prov('<?=$pro->id?>', '<?=$pro->nombre?>', '<?=$pro->tipo_contribuyente?>', '<?=$pro->ingreso_periodo_fiscal?>');" style="cursor:pointer"><?=$pro->rif?> - <?=$pro->nombre?></span>
				</td>
