...
<span style="text-align:left" class="titulo_maestro">
	Generar Reporte Descripcion Proyecto
</span>
<center>
...
<script type="text/javascript">
	...
	function imprimir()
	{
		...
		var escEnEje = <?=$escEnEje?>;
			...
			{
				wxR = window.open("reporteDescripcionProyecto.pdf.php?id_escenario=" + $('busca_escenario').value, "winX", "width=500, height=500, scrollbars=yes, resizable=yes, status=yes");
				wxR.focus()
			}
