...
$cCheque = cheque_anteriores::buscar($conn, $id_proveedor, $id_banco, $fecha_desde, $fecha_hasta, $nrodoc, $cuenta, "id", $inicio, $tamano_pagina);
$total = cheque_anteriores::totalRegsBusqueda($conn, $id_proveedor, $id_banco, $fecha_desde, $fecha_hasta, $nrodoc, $cuenta);
...
<table class="sortable" id="grid" cellpadding="0" cellspacing="1">
	...
	<tr class="filas"> 
		...
		<td align="center"><?=$op->status==0 ? '<a href="cheque.pdf.php?tipo=2&id='.$op->id.'" title="Emitir Reporte"><img style="width:16px; height:10px" src="images/reporte.jpg" border="0" /></a>' : "" ?></td>
