...
require_once $appRoot .'/lib/PHPExcel/DocumentProperties.php';

/** PHPExcel_DocumentSecurity */
require_once $appRoot .'/lib/PHPExcel/DocumentSecurity.php';

/** PHPExcel_Worksheet */
require_once $appRoot .'/lib/PHPExcel/Worksheet.php';

/** PHPExcel_Shared_ZipStreamWrapper */
require_once $appRoot .'/lib/PHPExcel/Shared/ZipStreamWrapper.php';

/** PHPExcel_NamedRange */
require_once $appRoot .'/lib/PHPExcel/NamedRange.php';

/** PHPExcel_WorksheetIterator */
require_once $appRoot .'/lib/PHPExcel/WorksheetIterator.php';
