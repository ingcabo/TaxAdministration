...
<br />
<span class="titulo_maestro">Maestro de Motivos para Desincorporación de Vehiculos</span>
<div id="formulario">
...
<td align="center">
<a href="veh_desincorporacion.php?accion=del&id=<?=$veh_desincorporacion->id?>" onclick="if (confirm('Si presiona Aceptar será eliminada esta información')){ return true;} else{return false;}" title="Modificar ó Actualizar Registro" ><img src="images/eliminar.gif" width="16" height="10" border="0"></a></td>
<td align="center">
<a href="#" onclick="updater('<?=$veh_desincorporacion->id?>'); return false;" title="Modificar ó Actualizar Registro" ><img src="images/actualizar.gif" width="16" height="10" border="0"></a></td>
