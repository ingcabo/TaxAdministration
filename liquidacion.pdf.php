<?
	...
	elseif ($ultimo_pago=$_REQUEST['ultimo_pago']>=0)
	{
...
class PDF extends FPDF
{
	function Header()
	{
			...
			//elseif($tipo == '009')
				$tipoOrden = "LIQUIDACION DE IMPUESTO DE VEHICULO";
...
$pdf->SetFont('Courier','',8);
$pdf->Cell(100,4, $ovehiculo->placa,0, '','L' ); $pdf->Ln();
...
$pdf->SetFont('Courier','',8);
$pdf->Cell(100,4, $ovehiculo->anio_veh,0, '','L' ); $pdf->Ln();
