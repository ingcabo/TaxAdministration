...
require_once $appRoot .'/lib/PHPExcel/Cell/DataValidation.php';

/** PHPExcel_Cell_Hyperlink */
require_once $appRoot .'/lib/PHPExcel/Cell/Hyperlink.php';

/** PHPExcel_Worksheet */
require_once $appRoot .'/lib/PHPExcel/Worksheet.php';

/** PHPExcel_Calculation */
require_once $appRoot .'/lib/PHPExcel/Calculation.php';

/** PHPExcel_Cell_IValueBinder */
require_once $appRoot .'/lib/PHPExcel/Cell/IValueBinder.php';

/** PHPExcel_Cell_DefaultValueBinder */
require_once $appRoot .'/lib/PHPExcel/Cell/DefaultValueBinder.php';
