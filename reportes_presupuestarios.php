	...
	<div align="left" id="formulario">
		<table width="454" border="0" align="center" style=" margin-left: auto; margin-right: auto; font-size:10px; ">
		  <tr>
              ...
              <option value="cp">Creditos Presupuestarios</option>
              <option value="rcp">Resumen Creditos Presupuestarios</option>
  			</select></td>
...
<script type="text/javascript">
	...
	function imprimir()
	{
        ...
        {
  				wxR = window.open("reporte_presupuestario.pdf.php?id_cp=" + $('busca_cp').value + "&id_escenario=" + $('busca_escenario').value, "winX", "width=500, height=500, scrollbars=yes, resizable=yes, status=yes");
  				wxR.focus()
				}
				else
				{
  				wxR = window.open("reporte_presupuestario.pdf.php?id_cp=" + $('id_cp').value + "&id_escenario=" + $('busca_escenario').value, "winX", "width=500, height=500, scrollbars=yes, resizable=yes, status=yes");
  				wxR.focus()
        }
