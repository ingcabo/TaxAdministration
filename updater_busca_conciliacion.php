...
?> 
	<tr class="filas"> 
		...
		<td align="center"><?=$conciliacion->fecha_desde?></td>
		<td align="center"><?= '<a href="reporteConciliacion.pdf.php?id='.$conciliacion->id.'" target="_blank" title="Emitir Reporte"><img style="width:16px; height:10px" src="images/reporte.jpg" border="0" /></a>'?></td>
		<td align="center"><a href="?accion=del&id=<?=$conciliacion->id?>" onClick="if (confirm('Si presiona Aceptar será eliminada esta información')){ return true;} else{return false;}"  title="Eliminar Registro"><img src="images/eliminar.gif" border="0" ></a></td>		
		<td align="center"><a href="#" onclick="updater(<?=$conciliacion->id?>); return false;" title="Modificar ó Actualizar Registro" ><img src="images/actualizar.gif" width="16" height="10" border="0"></a></td>
	</tr>
<?
	}
	$total_paginas = round($total / $tamano_pagina);
?>
	<tr class="filas">
