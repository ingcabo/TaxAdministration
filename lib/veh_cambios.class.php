...
class veh_cambios{
	...
	function add($conn, $id_contribuyente, $serial_carroceria, $placa, $fec_crea, $anio_veh, $serial_motor, $cod_mar, $cod_mod, $cod_col, $cod_uso,
		...
		$q = "INSERT INTO vehiculo.cambios ";
		$q.= "(id_contribuyente, serial_carroceria, placa, fec_mod, fec_crea, anio_veh, serial_motor, cod_mar, cod_mod, cod_col, cod_uso, cod_tip, 
