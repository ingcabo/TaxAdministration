...
$q="
SELECT 
  vehiculo.vehiculo.serial_motor AS serial_motor,
...
<td align="center"><?=$r->fields['serial_motor']?></td>
<td align="center">
<a href="#" onClick="updater(<?=$r->fields['id_vehiculo']?>); return false;" title="Modificar &eacute; Actualizar Registro" ><img src="images/actualizar.gif" width="16" height="10" border="0"></a></td>
